...
Status: In progress; eleven offline fixture sets are present, including narrow
reviewed classic-ONNX no-text, reading-order, tall-crop, and Unicode oracles;
other end-to-end, decoder, and tensor coverage remains pending
...
The current eleven committed offline fixture directories are also covered by
